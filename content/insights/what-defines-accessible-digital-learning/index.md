...
Bozarth, J. (no date) _"but it's to code": Thoughts on accessibility in e-learning, E-learning Heroes._ Available at: https://community.articulate.com/articles/but-it-s-to-code-thoughts-on-accessibility-in-e-learning

(WAI), W.C.W.A.I. (no date) _WCAG 2 Overview, Web Accessibility Initiative (WAI)._ Available at: https://www.w3.org/WAI/standards-guidelines/wcag/

WHO (no date) _Disability, World Health Organization. World Health Organization._ Available at: https://www.who.int/news-room/fact-sheets/detail/disability-and-health
